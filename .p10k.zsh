# Generated by Powerlevel10k configuration wizard on 2024-07-18 at 12:28 +07.
...
# slanted separators, round heads, flat tails, 1 line, compact, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#29db9d'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#ffeb95'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#ffeb95'
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#f7797d'
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND='#29db9d'
